...
<body>
	...
	<div>
		...
		<form:form action="saveCustomer" modelAttribute="customer"
			...
			<table>
				<tbody>
					...
					<tr>
						<td colspan="2">
						<form:textarea placeholder="Tell me about yourself" path="aboutMe" rows="3" cols="33" /></td>
					</tr>
		...
		<input type="button" value="Back to List"
			onclick="window.location.href='list/1'; return false;"
			class="add-button" />
